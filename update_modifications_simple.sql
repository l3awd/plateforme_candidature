-- Script de mise à jour simplifié pour les modifications du projet
-- Ce script applique toutes les modifications demandées
-- 1. Ajouter la colonne fiche_concours_url à la table Concours
ALTER TABLE Concours
ADD COLUMN fiche_concours_url VARCHAR(255);
