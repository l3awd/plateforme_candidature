...
public class Concours {
    ...
    @Column(name = "fiche_concours_url")
    private String ficheConcours;
    ...
    // Note: Relation bidirectionnelle commentée pour éviter les références
    // circulaires
    // Utiliser CandidatureRepository.findByConcours_Id(concoursId) pour récupérer
    // les candidatures
    // @OneToMany(mappedBy = "concours", cascade = CascadeType.ALL, fetch =
    // FetchType.LAZY)
